...
\usepackage{amssymb}
\usepackage{graphicx}
\usepackage{type1cm}  % Type 1 Computer Modern fonts
\usepackage{fix-cm}
\usepackage[left=2cm,right=2cm,top=2cm,bottom=2cm]{geometry}
%Thụt đầu dòng cho tất cả
...
Phương trình vi phân ngẫu nhiên đóng vai trò rất quan trọng trong kỹ thuật, vật lý, kinh tế và một số ngành khoa học khác. Sự ra đời của nó xuất phát từ hu cầu xác dịnh mối quan hệ giữa một bên là đại lượng biến thiên liên tục với một bên là độ biến thiên của đại lượng đó. Các mối quan hệ như thế xuất hiện thường xuyên trong các ứng dụng thực thế. Chẳng hạn, các biến động giá cả của một loại cổ phiếu trên thị trường hay sự thay đổi biến thiên của triều cường trong một khu vực bến cảng... Phương trình vi phân ngẫu nhiên luôn có mối quan hệ chặt chẽ với phép tính toán ngẫu nhiên và tích phân ngẫu nhiên để hình thành nên cơ sở của giải tích ngẫu nhiên. Nó còn hiện diện trong những chủ đề thời sự của giải tích, xác suất và được sử dụng rộng rãi trong nhiều lĩnh vực bên ngoài Toán học.
...
\end{itemize}
\pagebreak
\section{Dạng của phương trình vi phân ngẫu nhiên:}

\subsection{Một số phương trình đặc biệt}
\subsubsection{Phương trình vi phân tuyến tính thuần nhất}
...
\subsection{Phương trình vi phân tuyến tính dạng tổng quát}
...
\thispagestyle{empty}
\begin{enumerate}
	\item \textbf{Dương Tôn Đảm}, \textit{Quá trình ngẫu nhiên - Phần I: Tích phân và Phương trình vi phân ngẫu nhiên}, Nhà xuất bản Đại học Quốc gia Thành phố Hồ Chí Minh, Hồ Chí Minh, 2007.
	\item \textbf{Dương Tôn Đảm}, \textit{Quá trình ngẫu nhiên - Phần II: Các phép toán Malliavin}, Nhà xuất bản Đại học Quốc gia Thành phố Hồ Chí Minh, Hồ Chí Minh, 2010.
	\item \textbf{Dương Tôn Đảm}, \textit{Lớp quá trình ngẫu nhiên Itô - Levy và ứng dụng}, Nhà xuất bản Đại học Quốc gia Thành phố Hồ Chí Minh, Hồ Chí Minh, 2015.
	\item \textbf{Trần Hùng Thao}, \textit{Tích phân ngẫu nhiên \& phương trình vi phân ngẫu nhiên}, Nhà xuất bản Khoa học và Kỹ thuật, Hà Nội, 2000.
	\item \textbf{Bernt Oksendal}, \textit{Stochastic Differential Equations - An Introdution with Application}, Springer Verlag, 2006.
	\item \textbf{Krishna B. Athreya, Soumendra N. Lahiri}, Measure Theory and Probability Theory, Springer, New York, 2006.
\end{enumerate}
\newpage
\tableofcontents
